...
### Model description
CoSMoS-COAST is a large-scale, long-term shoreline model integrating longshore and cross-shore transport, presented in Vitousek et al. 2017 [[1](https://doi.org/10.1002/2016JF004065)], 2021 [[2](https://doi.org/10.1029/2019JF005506)], 2023 [[3](https://doi.org/10.1029/2022JF006936)].  The model presented in this submission (called "COSMOS-COAST-CONV") is an experimental version of the full CoSMoS-COAST model [[4](https://doi.org/10.5066/P95T9188)] that uses discrete convolution operations. The code of this experimental model is included with the submission.
