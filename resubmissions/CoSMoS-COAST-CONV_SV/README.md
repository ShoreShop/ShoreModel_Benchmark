## CoSMoS-COAST-CONV model (REVISED)
### Model description
...
### Revision
This revised version of the code uses two different convolution time for the cross-shore and longshore shoreline change components.  The original version used a single time scale for both components.  However, the differences between the two versions of the model are fairly small.
