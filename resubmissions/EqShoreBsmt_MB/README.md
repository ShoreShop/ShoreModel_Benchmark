...
This model was calibrated using smoothed shoreline positions between 1999 and 2018. The other settings are the same as those for EqShoreB, which was submitted first.
