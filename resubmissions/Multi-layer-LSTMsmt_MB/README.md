...
This model was trained using smoothed shoreline positions between 1999 and 2018. The other settings are the same as those for Multi-layer LSTM below, which was submitted first.
